...
export const ASK_USER_TOOL_DESCRIPTION =
    ...
    'PRIMARY TOOL FOR USER INTERACTION: Use this tool to ask questions (single or multiple), request confirmation, or present results. ' +
    'This tool REPLACES "ask_questions". Do not use "ask_questions". ' +
    'To ask multiple questions, use the "questions" array parameter. ' +
    'CRITICAL RULES: ' +
